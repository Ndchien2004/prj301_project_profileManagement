...
public class addChucVuServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("addChucVu.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Call DAO to add new position to database
        chucVuDAO chucVuDao = new chucVuDAO();
        chucVuDao.addChucVu(chucVu);

        // Redirect back to the chucvu.jsp with success message
        response.sendRedirect("chucVuServlet?success=true");
    }
    ...
    public String getServletInfo() {
        return "Servlet for adding new positions";
    }// </editor-fold>
